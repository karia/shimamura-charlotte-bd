<template>
  <div class="container">
    <div>
      ...
      <div>
        Vtuberユニット「Honey Strap -ハニーストラップ-」の島村シャルロットさんが8047歳のお誕生日を迎えました。<br>
        それを祝し、島村建設社員およびハニスコのみんなからのプレゼントとしてMinecraftの配布ワールドを建築いたしました。<br>
        マイクラが大好きなシャルちゃんと羊たちとの思い出を詰め込んだシャル ”の ” 羊の世界！<br
        是非遊びに来てください！
      </div>
      ...
      <p>このワールドについての感想は #シャルの羊の世界2020 のハッシュタグをつけてツイートしてください！</p>
      ...
      <section class="download">
        ...
        <div class="links">
          ...
          <p>（対応バージョンをよく確認してください！）</p>

          <h3 class="sectiontitle">
            マインクラフト1.16.1に対応したデータはこちらから
          </h3>
          
          <p><a
            href="charlotte-world-1.16.1-2020-07-13-06-07-35.zip"
            class="button--green"
          >
            バージョン1.16.1対応データ　ダウンロード（82MB）
          </a></p>
      ...
      <section id="settings">
        ...
        <div class="links">
          <p>
            本ワールドは「マインクラフト Java Edition バージョン1.16.1」にて動作確認を行っております。<br>
            ゲームモードは「クリエイティブ」を推奨します（エリアによって他のゲームモードに切り替わる場合があります）。
          </p>
      ...
      <section class="terms">
        ...
        <div class="links">
          <p>本配布ワールドの利用につきましては、ローカルでのプレイ・マルチでのプレイ・配信での利用など、自由に利用いただいて問題ありません。</p>
          <p>ただし、本ワールドは<a href="https://www.774.ai/guideline">774inc.の二次創作ガイドライン</a>に従って制作・配布していますので、こちらをご一読頂きますようお願いいたします。</p>
        </div>
      </section>

      <section class="terms">
        <h2 class="subtitle">
          配布ワールドデータをマインクラフトに入れる方法
        </h2>
      ...
      <section id="faq">
        ...
        <div class="links">
          <h3>サバイバルモードへの変更方法</h3>
          <p>本ワールドのゲームモードは、クリエイティブモードになっています。サバイバルモードへ変更する場合は、「LANへ公開」を押したあと「/gamemode survival」と入力して下さい。</p>
        </div>
      </section>
      ...
      <section class="about">
        ...
        <p>
          ...
          しっかりした悪魔になろうと、一日一悪を掲げるものの、根が素直でいい子なのでなかなか悪いことができない。<br>
          （<a href="https://spwn.jp/events/191222-honeystrap">https://spwn.jp/events/191222-honeystrap</a> より引用）
        </p>
        <div class="links">
          <a
